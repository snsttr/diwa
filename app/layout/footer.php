    ...
    <div class="container">
        <footer class="text-center">
            <div class="btn-group">
                ...
                <a href="https://github.com/snsttr/diwa" target="_blank" class="btn btn-default" data-toggle="tooltip" title="GitHub"><i class="fa fa-github" aria-hidden="true"></i></a>
                ...
                <a href="https://github.com/snsttr" target="_blank" class="btn btn-default" data-toggle="tooltip" title="DIWA's Developer"><i class="fa fa-user" aria-hidden="true"></i></a>
            </div>
        </footer>
    </div>
<?php } ?>
